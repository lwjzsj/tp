...
<body>
    ...
    <div id="main">
        ...
        <div id="content">
            <form action="/tp/index.php/Home/Phone/newthemewrite" enctype="multipart/form-data" method="POST" onsubmit="return chick(this)">

                <input type="text" name="title" id="intitle" placeholder="标题">
                <textarea id="text" name="content" placeholder="内容"></textarea>
                <div id="img">
                    <?php $__FOR_START_11555__=1;$__FOR_END_11555__=6;for($i=$__FOR_START_11555__;$i < $__FOR_END_11555__;$i+=1){ ?><div class="imgbox" id="img<?php echo ($i); ?>">
                            <div id="<?php echo ($i); ?>" class="smart"><img class="imge" id="imge<?php echo ($i); ?>" /></div>
                            <input type="file" class="file" id="file<?php echo ($i); ?>" name="file<?php echo ($i); ?>" accept="image/*">
